...
# Configurations
matrix_sizes= (100 128 200 256) # Matrix sizes; leave out 512 for now
associativity= (1, 2, 4, 8) # Cache associativity
replacement_policy=("Random", "LRU", "MRU") # Cache replacement policy
# prefetcher="false" # Enable/disable prefetcher
# write_allocator="true" # Enable/disable write allocator
