...
from configs import matrix_sizes, block_sizes, axis_params, init_block_sizes

gem5_exe = "../build/X86/gem5.opt"
script = "system_l1.py"
out_root = "out"
max_workers = 18  # Adjust to use fewer cores if needed
        ...
        with ProcessPoolExecutor(max_workers=max_workers) as executor:
            ...
            for future in as_completed(futures):
                ...
                try:
                    future.result()
                    completed += 1
                    print(f"[{completed}/{len(jobs)}] Finished: {outdir}, time passed: {time.time() - start_time:.2f} seconds")
